(function () {
  ...
  function smFooterHtml() {
    return [
      ...
      '<a class="sm-footer-item" href="https://www.google.com/maps/search/?api=1&query=Av.%20Argentina%2C%20C.%20C%20245%2C%20Lima%2015082%2C%20Per%C3%BA" target="_blank" rel="noopener">',
      ...
      '<span>Av. Argentina, C. C 245,<br>Lima 15082, Per&uacute;.</span>',
      '</a>',
      '<a class="sm-footer-item" href="https://www.google.com/maps/search/?api=1&query=Av.%20%C3%93scar%20R.%20Benavides%20282%2C%20Lima%2015082%2C%20Per%C3%BA" target="_blank" rel="noopener">',
      '<span class="sm-footer-icon"><svg viewBox="0 0 24 24" aria-hidden="true"><path d="M12 21s7-6.1 7-12A7 7 0 0 0 5 9c0 5.9 7 12 7 12Zm0-8.2A3.8 3.8 0 1 1 12 5.2a3.8 3.8 0 0 1 0 7.6Z"/></svg></span>',
      '<span>Av. &Oacute;scar R. Benavides 282,<br>Lima 15082, Per&uacute;.</span>',
      '</a>',
      '</section>',
      '<section class="sm-footer-col">',
      ...
      '<section class="sm-footer-col">',
      '<h3>E-mail</h3>',
      '<a class="sm-footer-item" href="mailto:ventas@smindustrial.com.pe"><span class="sm-footer-icon"><svg viewBox="0 0 24 24" aria-hidden="true"><path d="M4 5h16c.6 0 1 .4 1 1v12c0 .6-.4 1-1 1H4c-.6 0-1-.4-1-1V6c0-.6.4-1 1-1Zm8 7.6L5.3 7H5v10h14V7h-.3L12 12.6Zm0-2.5L15.9 7H8.1l3.9 3.1Z"/></svg></span><span>ventas@smindustrial.com.pe</span></a>',
      '</section>',
      '<section class="sm-footer-col">',
      '<h3>S&iacute;guenos</h3>',
      '<a class="sm-footer-item" href="https://www.tiktok.com/@smindustrial.pe" target="_blank" rel="noopener" aria-label="Abrir TikTok de Industriales El&eacute;ctricos S&amp;M"><span class="sm-footer-icon"><svg viewBox="0 0 24 24" aria-hidden="true"><path d="M15.2 3c.4 2.7 1.9 4.6 4.6 5v3.1c-1.6 0-3.1-.5-4.6-1.4v5.8c0 3.4-2.5 5.8-5.8 5.8A5.4 5.4 0 0 1 4 15.9c0-3.1 2.4-5.5 5.5-5.5.5 0 .9.1 1.3.2v3.2c-.4-.2-.8-.3-1.3-.3-1.3 0-2.3 1-2.3 2.3s1 2.3 2.3 2.3 2.4-.9 2.4-2.5V3h3.3Z"/></svg></span><span>TikTok</span></a>',
      '</section>',
      '</div>',
